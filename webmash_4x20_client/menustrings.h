// this file is for string declarations for menus only
#include <libintl.h>
...
#define MSELECTTXT4 gettext_noop("Network info")     
...
#define MTEXTMAC gettext_noop("MAC-address")
#define MTEXTIP4 gettext_noop("IPv4-address")
#define MTEXTIP6 gettext_noop("IPv6 global")
